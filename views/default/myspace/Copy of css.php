...
.bottombar-active a {
	box-shadow: inset 0px -3px 0px 0px #2e88c4;
 	-moz-box-shadow: inset 0px -3px 0px 0px #2e88c4;
 	-webkit-box-shadow: inset 0px -3px 0px 0px #2e88c4;
}
...
.bottombar-friends a {
	background: url(<?php echo elgg_get_site_url() . "mod/myspace/images/friends.png" ?>) no-repeat center center;
	width: 30px;
	height: 60px;
	vertical-align: middle;
	line-height: 60px;
...
.bottombar-friends a:hover {
	background: url(<?php echo elgg_get_site_url() . "mod/myspace/images/friends-hover.png" ?>) no-repeat center center;
}

.bottombar-messages a {
	background: url(<?php echo elgg_get_site_url() . "mod/myspace/images/messages.png" ?>) no-repeat center center;
	width: 30px;
	height: 60px;
	vertical-align: middle;
	line-height: 60px;
...
.bottombar-messages a:hover {
	background: url(<?php echo elgg_get_site_url() . "mod/myspace/images/messages-hover.png" ?>) no-repeat center center;
}
...
.bottombar-search .elgg-search input[type="text"], .bottombar-search-active .elgg-search input[type="text"] {
	-webkit-border-radius: 0px;
	-moz-border-radius: 0px;
	border-radius: 0px;
	border: 0;
	font-size: 130%;
	background: url("<?php echo elgg_get_site_url() . "mod/myspace/images/search.png" ?>") no-repeat 0px center;
	color: #aaa;
	font-weight: normal;
	height: 60px;
	width: 540px;
...
.bottombar-search .elgg-search input[type="text"]:hover, .bottombar-search-active .elgg-search input[type="text"]:hover {
	background: url("<?php echo elgg_get_site_url() . "mod/myspace/images/search-hover.png" ?>") no-repeat scroll 0px center;
	color: white;
	border: 0;
}

.bottombar-search .elgg-search input[type="text"]:focus, .bottombar-search .elgg-search input[type="text"]:active, .bottombar-search-active .elgg-search input[type="text"]:focus {
	background: url("<?php echo elgg_get_site_url() . "mod/myspace/images/search-hover.png" ?>") no-repeat scroll 0px center;
	border: 0;
	color: white;
}

.bottombar-settings a {
	background: url(<?php echo elgg_get_site_url() . "mod/myspace/images/settings.png" ?>) no-repeat center center;
	width: 30px;
	height: 60px;
	vertical-align: middle;
	line-height: 60px;
...
.bottombar-settings a:hover {
	background: url(<?php echo elgg_get_site_url() . "mod/myspace/images/settings-hover.png" ?>) no-repeat center center;
}
